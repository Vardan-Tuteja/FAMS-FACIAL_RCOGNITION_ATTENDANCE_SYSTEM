    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = 'C:/Users/varda/Desktop/PROFESSIONAL/project/ml/FAMS/Attendance/Manually Attendance/'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,"C:/Users/varda/Desktop/PROFESSIONAL/project/ml/FAMS/Attendance/Manually Attendance-------Check atttendance-------"')
    ...
    if l1 == '':
        ...
        try:
            ...
            detector = cv2.CascadeClassifier(
                'C:/Users/varda/Desktop/PROFESSIONAL/project/ml/FAMS/haarcascade_frontalface_default.xml')
            Enrollment = txt.get()
            Name = txt2.get()
            sampleNum = 0
            while (True):
                ...
                for (x, y, w, h) in faces:
                    ...
                    cv2.imwrite("C:/Users/varda/Desktop/PROFESSIONAL/project/ml/FAMS/TrainingImage/ " + Name + "." + Enrollment + '.' + str(sampleNum) + ".jpg",
                                gray)
            ...
            with open('C:/Users/varda/Desktop/PROFESSIONAL/project/ml/FAMS/StudentDetails/StudentDetails.csv', 'a+') as csvFile:
...
try:
    ...
    print("cv2.face module not found. OpenCV may be improperly installed.")
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                try:
                    recognizer.read("C:/Users/varda/Desktop/PROFESSIONAL/project/ml/FAMS/TrainingImageLabel/Trainner.yml")
                except:
                ...
                harcascadePath = "C:/Users/varda/Desktop/PROFESSIONAL/project/ml/FAMS/haarcascade_frontalface_default.xml"
                faceCascade = cv2.CascadeClassifier(harcascadePath)
                df = pd.read_csv("C:/Users/varda/Desktop/PROFESSIONAL/project/ml/FAMS/StudentDetails/StudentDetails.csv")
                cam = cv2.VideoCapture(0)
                ...
                root.configure(background='grey80')
                cs = 'C:/Users/varda/Desktop/PROFESSIONAL/project/ml/FAMS/' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(
            r'explorer /select,"C:/Users/varda/Desktop/PROFESSIONAL/project/ml/FAMS/Attendance/-------Check atttendance-------"')
    ...
    def log_in():
        ...
        if username == 'vardan':
            if password == 'vardan123':
                ...
                cs = 'C:/Users/varda/Desktop/PROFESSIONAL/project/ml/FAMS/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
